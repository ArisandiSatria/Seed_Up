...
$query = query("SELECT * FROM pesanan_customer");
...
<body>
    ...
    <div class="container mt-5">
        <h5 style="color: rgba(255, 117, 24, 1);">Terima Kasih Sudah Memesan!</h5>
        <h2 class="mb-4" style="font-weight: bold;">Pesanan Anda</h2>
            ...
            <?php foreach ($query as $a): ?>                
                <div class="col mb-3">
                    <div class="card h-100 border-0 rounded-3">
                        <div class="card-body">
                            <h4 class="card-title my-2 d-inline">Pesanan <?=$a['id_pesanan']?></h4>
                        </div>
                        <div class="card-footer border-0" style="background-color: white;">
                            <a href="detailPesananCustomer.php?id=<?=$a["id_pesanan"]?>" class="btn btn-warning" style="background-color: rgba(255, 117, 24, 1); color: white;" >Detail Produk</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
