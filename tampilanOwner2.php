...
$result = query("SELECT * FROM transaksi_pesanan");
?>
                ...
                <div class="col mb-3">
                    <div class="card h-100 border-0 rounded-3">
                        ...
                        <div class="card-footer border-0" style="background-color: white;">
                            <a href="detailPesanan.php?id=<?=$a['id_pesanan']?>" class="btn btn-warning" style="background-color: rgba(255, 117, 24, 1); color: white;" >Detail Produk</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
